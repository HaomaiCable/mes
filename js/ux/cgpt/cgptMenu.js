$package('YiYa.cgptMenu');

YiYa.cgptMenu = function(){
	var _box = null;
	var _this = {
  			...
  			dataGrid:{
			    ...
			    pageList: [10, 20, 30, 40, 50],
	   			columns:[[
					...
					{field:'rank',title:'Rank',align:'right',width:40,sortable:true},
					{field:'url',title:'URL',width:280,sortable:true},
					{field:'actions',title:'Actions',width:260,sortable:true},
					{field:'createTime',title:'CreateTime',width:150,sortable:true},
					{field:'updateTime',title:'UpdateTime',width:150,sortable:true},
					{field:'childMenus',title:'Child Menus',width:100,align:'center',formatter:function(value,row,index){
						var html ="<a href='#' onclick='YiYa.cgptMenu.toList("+row.id+")'>子菜单管理("+row.subCount+")</a>";
						return html;
					}}
				]],
				toolbar:[
