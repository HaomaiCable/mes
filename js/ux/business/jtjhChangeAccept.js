$package('YiYa.jtjhChangeAccept');

YiYa.jtjhChangeAccept = function(){
	var _box = null;
	var _this = {
 
		config:{
			action:{
 				save:'saveDdbgAccept.do',
 			...
 			dataGrid:{
			    ...
			    pageList: [100, 200, 300, 400, 500],
	   			columns:[[
					...
					{field:'jhbh',title:'生产计划编号',width:100,sortable:true},	
				...
				toolbar:[
					{id:'btnedit',text:'变更确认',btnType:'edit'}
