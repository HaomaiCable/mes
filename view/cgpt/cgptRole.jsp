...
<div class="warp easyui-panel" data-options="border:false">
	<!-- Search panel start -->
     ...
     <!-- Edit Form -->
     <div id="edit-win" class="easyui-dialog" title="编辑" data-options="closed:true,iconCls:'icon-save',modal:true" style="width:400px;height:410px;">  
     	<form id="editForm" class="ui-form" method="post">  
     		 <input class="hidden" type="text" name="id">
     		 <div class="ui-edit">
	     	   <div class="ftitle">供应商角色信息</div>    
	           <div class="fitem">  
	               <label>角色名称:</label>  
...
<script type="text/javascript" src="${msUrl}/js/ux/cgpt/cgptRole.js"></script>
  </body>
</html>
