...
<div class="warp easyui-panel" data-options="border:false">
	 ...
	 <!-- Search panel start -->
 	 ...
 	 <form id="searchForm">
 	 	<p class="ui-fields">
            <label class="ui-label">招标物资名称:</label>
     ...
     <!-- Edit Win&Form -->
     <div id="edit-win" class="easyui-dialog" title="招标物资" data-options="closed:true,iconCls:'icon-save',modal:true" style="width:340px;height:220px;">  
     	<form id="editForm" class="ui-form" method="post">  
     		 <input class="hidden" name="id">
     		  <div class="ui-edit">
		     	   <div class="ftitle">招标物资信息</div>    
		           <div class="fitem">  
		               <label>招标物资名称:</label>  
...
<script type="text/javascript" src="${msUrl}/js/ux/cgpt/zbwz.js"></script>
  </body>
</html>
