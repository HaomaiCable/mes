...
<div class="warp easyui-panel"  data-options="border:false">
 	 ...
 	 <div class="easyui-panel ui-search-panel" title="查询窗口" data-options="striped: true,collapsible:true,iconCls:'icon-search'">   
 	     <form id="searchForm">
 	 	    ...
 	 	    <p class="ui-fields">
                ...
                <label class="ui-label">审核单编号:</label> 
  ...
  <script type="text/javascript" src="${msUrl}/js/ux/business/xsddChangeCheck.js"></script> 
 
<script type="text/javascript"> 
    function cancelquit(){ 
       $.messager.confirm('提示','你确认要放弃【审核单审核】吗',function(r){  
	       if (r){  
	...
	function savechange(){
        ...
        $.post("${msUrl}/xsddManage/saveDdbgCheck.do", effectRow,function(rsp) {  
