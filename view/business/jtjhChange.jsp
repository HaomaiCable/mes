	              ...
	              <div class="easyui-layout" data-options="fit:true">  
					   ...
					   <div data-options="region:'center'"> 
					         <div class="fitem">  
					             ...
					             <label>---->:</label>  
					             <input  type="text" name="sbmcnew"   style="width:160px;" >
							 </div>	
					         <div class="fitem">  
					             <label>主零:</label>  
					             <input  type="text" name="iszl"   style="width:160px;" readonly="readonly">
					             <label>---->:</label>  
					             <input  type="text" name="iszlnew"   style="width:160px;" >
							 </div>								 
						     <div class="fitem">  
					             <label>型号:</label>  
					             <input  type="text" name="gxxh"   style="width:160px;" readonly="readonly">
					             <label>---->:</label>  
					             <input  type="text" name="gxxhnew"   style="width:160px;" >
							 </div>
					         <div class="fitem">  
					             <label>规格:</label>  
					             <input  type="text" name="gxgg"   style="width:160px;" readonly="readonly">
					             <label>---->:</label>  
					             <input  type="text" name="gxggnew"   style="width:160px;" >
							 </div>
					         <div class="fitem">  
					             <label>电    压:</label>  
					         ...
					         <div class="fitem">  
					             ...
					             <label>---->:</label>  
					             <input  type="text" name="jhsl_xsnew"   style="width:160px;" data-options="editor:{type:'numberbox',options:{precision:1}}">
							 </div>
					         <div class="fitem">  
					             <label>机台数量:</label>  
					             <input  type="text" name="jhsl_o"   style="width:160px;" readonly="readonly" >
					             <label>---->:</label>  
					             <input  type="text" name="jhsl_onew"   style="width:160px;" data-options="editor:{type:'numberbox',options:{precision:1}}">
							 </div>
					         <div class="fitem">  
					             <label>完工日期:</label>  
