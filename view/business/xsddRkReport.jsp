 	     ...
 	     <form id="searchForm">
 	 	    ...
 	 	    <p class="ui-fields">
                ...
                <label>产品规格:</label>  
			        ...
			        textField:'text'">
               <label>完工主手:</label>  
		            <input  class="easyui-combobox"  name="wgzs"  style="width:60px;" 
				    data-options="
			        ...
			        valueField:'xm',
			        textField:'xm'">
               <label class="ui-label">完工日期: </label><input name="wgrq" class="easyui-datebox" style="width:100px;">
                    ...
                    <div data-options="region:'center'">  
                         <table id="dg-xsddrkhb" >
                            ...
                            <tr>
   	                        <input class="hidden" name="id">
	                       <!-- 
							<th data-options="field:'wgrq',disabled:true,width:100,editor:'datebox', required:true,
                                  formatter:function(value,row,index) {
                                      if (value != null) {
							...
							">完工日期</th>
	                         ...
	                         <th field="wgsl" width="80" align="right"  readonly="readonly"
							      data-options="editor:{type:'numberbox',options:{precision:2}}, required:true"
							 >完工数量</th>
  
   	                        <th field="wgslss" width="150" readonly="readonly" editor="text">
							完工数量--实数</th>
							<th data-options="field:'czg',width:80,disabled:true,
						       editor:{
							      type:'combobox',
							      options:{
								     valueField:'xm',
							...
							<th data-options="field:'xpgg',width:80,disabled:true,
						       editor:{
							      type:'combobox',
							      options:{
								     valueField:'id',
	                        ...
	                        <th field="cmsl" width="80" align="right"   readonly="readonly"
							      data-options="editor:{type:'numberbox',options:{precision:2}}"
							 >长米割去数量</th>	
							 -->
                            <th field="wgrq" width="80" >完工日期</th>	
                            <th field="wgsl" width="80" >完工数量</th>		
                            <th field="wgslss" width="120" >完工数量--实数</th>		
                            <th field="czg" width="80" >完工机台主手</th>	
                            <th field="xpgg" width="80" >线盘规格</th>
                            <th field="cmsl" width="80" >长米割去数量</th>									
	                        <th field="rk" width="60" align="center"  
							      data-options="editor:{type:'checkbox',options:{on:1,off:0}}"
							 >入库确认</th>		
							<th field="rksm" width="200" editor="text">入库说明</th>
  		                    <th field="rklrBy" width="70" >录入</th>
	                        <th field="rklrTime" width="150" >时间</th>
	                        </tr>
	                        </thead> 
                        </table>	
                    </div>
      ...
      function cancelquit(){ 
       $.messager.confirm('提示','你确认要放弃以上修改吗',function(r){  
	       if (r){  
		       ...
		       $("#dg-xsddrkhb").datagrid('reload');
		       $("#dg-xsddrkhb").datagrid('loadData', { total: 0, rows: [] }); 
