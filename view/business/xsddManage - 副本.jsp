...
<div class="warp easyui-panel"  data-options="border:false">
     ...
     <!-- 订单明细DataList  -->
     <form id="listFormmx"  method="post" >
	
	     <table id="data-listmx"   
		     url="dataList.do"
			 singleSelect="true"
			 pagination="true"
			 rownumbers="true"
			 ...
			 >
		         <thead>
			      <tr>
				    ...
				    <th field="gy" width="40" >工艺</th>
			  	    <th field="dw" width="40">单位</th>
			  	    <th field="ph" width="80" >批号</th>
	        ...
	        <div class="easyui-layout" data-options="fit:true">  
	          <div data-options="region:'north',split:true" style="height:90px;padding:10px">  
	            ...
	            <table id="tt" style="height:auto"
			           url="${msUrl}/xsddManage/dataList.do"
			           singleSelect="true"
					   pagination="true"
					   rownumbers="true"
					  	iconCls="icon-edit"
