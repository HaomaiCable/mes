...
<div class="warp easyui-panel"  data-options="border:false">
 	 ...
 	 <div class="easyui-panel ui-search-panel" title="查询窗口" data-options="striped: true,collapsible:true,iconCls:'icon-search'">   
 	     <form id="searchForm">
 	 	    ...
 	 	    <p class="ui-fields">
                ...
                <label class="ui-label">机台计划单编号:</label> 
     ...
     <div id="edit-win" class="easyui-dialog"   buttons="#edit-win-dlgbuttons"  
		 ...
		 style="width:760px;height:640px;">  

     	 <form id="editForm" class="ui-form" method="post"> 
     	      <!-- 隐藏文本框 -->
     	      <input class="hidden" name="id">
 			  <!--<input class="hidden" name="parentId" id='edit_parentId'> -->
    	      <div class="easyui-panel" border='false' style="height:560;">  
  ...
  <script type="text/javascript" src="${msUrl}/js/ux/business/jtjhChangeAccept.js"></script> 
...
<script type="text/javascript"> 
	...
	function savechange(){
        ...
        $.post("saveDdbgAccept.do", effectRow,function(rsp) {  
