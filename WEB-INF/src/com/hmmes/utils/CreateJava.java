...
public class CreateJava {
	...
	private static String passWord = res.getString("gpt.password");
	 ...
	 //项目跟路径路径，此处修改为你的项目路径
	private static String rootPath = "F:\\360云盘\\hmmesWork\\hmmes_SERVICE\\";//getRootPath();// "F:\\openwork\\open\\";
	private static String actionPath = "F:\\360云盘\\hmmesWork\\hmmes_MS\\src\\com\\hmmes\\";
