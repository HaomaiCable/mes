...
//System.out.println("高绪山SysUseruserid"+bean.getId());
...
//System.out.println("高绪山-SysUser-data"+data.toString());
		context.put(SUCCESS, true);
		context.put("data", data);
//System.out.println("高绪山-SysUser-context"+context.toString());
		HtmlUtil.writerJson(response, context);
	}
	...
	@RequestMapping("/sysUserListJson")  //用户combobox 选择数据
...
//System.out.println("高绪山-SysUser"+jsonArr.toString());
