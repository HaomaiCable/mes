...
public class ZbggBean extends BaseBean {
    ...
    private int subCountTb;//投标明细记录数,与数据库字段无关
    private int subCountMx;//招标物资明细记录数,与数据库字段无关
	private int distGgbh;//不重复的招标公告编号记录数,与数据库字段无关
	//投标明细
	...
	public int getSubCountTb() {
		return this.subCountTb;
	}
	public void setSubCountTb(int subCountTb) {
		this.subCountTb = subCountTb;
	}	
	public int getSubCountMx() {
		return this.subCountMx;
	}
	public void setSubCountMx(int subCountMx) {
		this.subCountMx = subCountMx;
	}	
	public int getDistGgbh() {
		return this.distGgbh;
	}
	public void setDistGgbh(int distGgbh) {
		this.distGgbh = distGgbh;
	}	
