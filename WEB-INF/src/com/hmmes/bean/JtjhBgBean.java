...
public class JtjhBgBean extends BaseBean {
	...
	private String oldContent_dc;//  变更前内容，与数据库无关，导出打印用
	private String newContent_dc;//   变更后内容，，与数据库无关，导出打印用

	public String getOldContent_dc() {
	    return this.oldContent_dc;
	}
	public void setOldContent_dc(String oldContent_dc) {
	    this.oldContent_dc=oldContent_dc;
	}
	public String getNewContent_dc() {
	    return this.newContent_dc;
	}
	public void setNewContent_dc(String newContent_dc) {
	    this.newContent_dc=newContent_dc;
	}
