...
public class TbxxBean extends BaseBean {
	...
	private String gysStr;//供应商名称,与数据库无关	
	private Integer kb;//是否开标,1=开标,与数据库无关	
	private Integer qd;//是否确定供应商,1=已确定,与数据库无关	
	private Integer sp;//是否审批已确定的供应商,1=已审批,与数据库无关	


	public String getGysStr() {
		return this.gysStr;
	}
	public void setGysStr(String gysStr) {
		this.gysStr = gysStr;
	}
